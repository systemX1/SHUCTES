...
func GetUserCommentedCourseHandler() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		sql := `
SELECT course.uid, course.cid, course.name, course.teachno, course.teachname, comment.content
...
AND username = ?; `
		...
		for rows.Next() {
			if err := rows.Scan(&jsonSent.CourseUid, &jsonSent.CourseCid, &jsonSent.CourseName, &jsonSent.TeachNo, &jsonSent.TeachName, &jsonSent.Comment); err != nil {
