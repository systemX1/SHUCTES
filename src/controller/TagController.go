...
func GetUserTaggedCourseHandler() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		sql := `
SELECT course.uid, course.name, course.teachname, tag.tag_idx
...
AND username = ?; `
		...
		for rows.Next() {
			if err := rows.Scan(&jsonSent.CourseUid, &jsonSent.CourseName, &jsonSent.TeachName, &jsonSent.TagIdx); err != nil {
